...
# Пример для _example_project (демо-проект, ГОСТ, русский)
...
page_numbers_start: 3 # нумерация с 3-й страницы (титул и оглавление не нумеруются)
...
## Особые требования
custom_notes: |
  Оглавление не нумеруется как раздел.
  Введение начинается с нечётной страницы.
