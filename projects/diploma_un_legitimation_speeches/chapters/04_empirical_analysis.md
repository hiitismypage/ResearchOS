...
The *victim_narrative* role appears in isolated cases where the accused state reframes itself as the injured party: Azerbaijan's 2020 speech on the Second Nagorno-Karabakh conflict (16.7 percent victim_narrative) illustrates the rhetorical mechanics of victim repositioning with particular clarity: by foregrounding what the speaker characterizes as decades of prior Armenian conduct in Nagorno-Karabakh, the address reframes the initiating actor in the military exchange as a respondent — displacing the normative question of who initiated force onto a prior grievance narrative and thereby converting a justification of offensive action into an account of defensive necessity, and Israel's 2009 speech on Operation Cast Lead (33.3 percent historical_context alongside 66.7 percent justification). The structural logic is consistent across these cases: the state does not primarily deny the alleged conduct but claims it was a response to prior victimization, thereby repositioning the normative burden of justification onto the accusing parties.
